...
SQL;
	...
	$sqlInsert[0] = "INSERT INTO `internalGroups` (`id`, `groupName`, `groupType`, `description`, `groupDn`, `permissions`, `visible`, `createdBy`, `createdDate`) VALUES(1, 'Administrators', 0, 'Internal Administrators Group', 'CN=Administrators,CN=Groups,DC=System,DC=Local', 3, 1, '$systemSID', '2019-05-01 00:00:00')";
